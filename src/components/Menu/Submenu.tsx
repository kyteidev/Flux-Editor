...
const Submenu = (props: {
  ...
  return (
    <>
      <div
        class={`${props.first && "rounded-t"} ${props.last && "rounded-b"} ${props.separator && "border-t-[1px] border-base-100-hover"} absolute z-[51] flex h-6 w-32 items-center bg-base-100 px-2 align-middle text-sm hover:bg-base-100-hover`}
